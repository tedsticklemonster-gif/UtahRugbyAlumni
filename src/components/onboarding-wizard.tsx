        ...
        {step === 4 && (
          <div className="space-y-4">
            ...
            <a
              ...
              className="flex items-center gap-3 rounded-xl border border-[#26A5E4]/30 bg-[#26A5E4]/10 px-4 py-3.5 transition-colors hover:bg-[#26A5E4]/20"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="size-7 shrink-0 text-[#26A5E4]" aria-hidden="true">
